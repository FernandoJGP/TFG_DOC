...
El uso de una metodología es esencial cuando estamos hablando de ingeniería software: ayuda a planear y controlar el proceso de desarrollo del software, así como a gestionar los recursos de los que se disponen.
...
\begin{itemize}
	...
	\item Y, por último, \textbf{las conclusiones sobre la metodología} (\ref{sec:conclusionesmetodologia}), sección en la que se extraerán unas breves conclusiones.
\end{itemize}
...
La \textbf{documentación} se generaría de forma constante durante todo el transcurso del proyecto y se haría de forma iterativa, tanto cada vez que se empezara a diseñar una funcionalidad como cuando se terminase el diseño de la misma.
...
Para finalizar, los \textbf{roles} también necesitan adaptarse al proyecto, ya que muchos de ellos dejan de tener sentido por las mismas razones que se citaban anteriormente. En este caso es necesario aplicar una simplificación, que llevaría a que los roles de programador se aglutinaran en uno solo y lo mismo pasaría con los roles de diseño, lo que daría lugar a:
