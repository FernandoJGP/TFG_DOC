...
\begin{table*}[h!]
	...
	\begin{coolTable}{p{2.35cm}p{\textwidth-3.5cm}}{2}
		...
		\textbf{Alternativas}&-\\
	\end{coolTable}
	\caption{Memorando técnico 1001: Creación del personaje}
\end{table*}
...
\begin{table*}[h!]
	...
	\end{coolTable}
	\caption{Memorando técnico 1002: Creación de la cámara TFP}
\end{table*}
...
\begin{table*}[h!]
	...
	\end{coolTable}
	\caption{Memorando técnico 1003: Creación de la cámara TP}
\end{table*}
...
\begin{table*}[h!]
	...
	\begin{coolTable}{p{2.35cm}p{\textwidth-3.5cm}}{2}
		...
		\textbf{Alternativas}&-\\
	\end{coolTable}
\caption{Memorando técnico 1004: Movimiento del personaje}
\end{table*}
...
\begin{table*}[h!]
	...
	\begin{coolTable}{p{2.35cm}p{\textwidth-3.5cm}}{2}
		...
		\textbf{Alternativas}&-\\
	\end{coolTable}
	\caption{Memorando técnico 1005: Rotación de cámara y personaje}
\end{table*}
...
\begin{table*}[h!]
	...
	\begin{coolTable}{p{2.35cm}p{\textwidth-3.5cm}}{2}
		...
		\textbf{Alternativas}&-\\
	\end{coolTable}
	\caption{Memorando técnico 1006: Rotación de cámara y personaje (para controladores)}
\end{table*}
...
\begin{table*}[h!]
	...
	\begin{coolTable}{p{2.35cm}p{\textwidth-3.5cm}}{2}
		...
		\textbf{Alternativas}&-\\
	\end{coolTable}
	\caption{Memorando técnico 1007: Sprint}
\end{table*}
...
\begin{table*}[h!]
	...
	\begin{coolTable}{p{2.35cm}p{\textwidth-3.5cm}}{2}
		...
		\textbf{Alternativas}&-\\
	\end{coolTable}
	\caption{Memorando técnico 1009: Agachar}
\end{table*}
...
\begin{asigResponsabilidad}{1004}{Añade movimiento en la dirección del personaje o en la opuesta}
...
\begin{asigResponsabilidad}{1004}{Añade movimiento a izquierda o derecha de la dirección del personaje}
...
\begin{asigResponsabilidad}{1005}{Añade rotación horizontal a la cámara}
...
\begin{asigResponsabilidad}{1005}{Añade rotación vertical a la cámara}
...
\begin{asigResponsabilidad}{1006}{Añade rotación horizontal a la cámara para controladores}
...
\begin{asigResponsabilidad}{1006}{Añade rotación vertical a la cámara para controladores}
...
\begin{asigResponsabilidad}{1007}{El personaje entra en modo sprint}
...
\begin{asigResponsabilidad}{1007}{El personaje entra en modo caminar}
...
\begin{asigResponsabilidad}{1008}{El personaje salta}
{[void] OnJump ()}
...
\begin{asigResponsabilidad}{1008}{El personaje deja de saltar}
{[void] StopJumping ()}
...
\begin{asigResponsabilidad}{1009}{El personaje se agacha}
...
\begin{asigResponsabilidad}{1009}{El personaje deja de agacharse}
...
\begin{asigResponsabilidad}{1010}{El personaje entra en tiempo bala o sale de él}
...
\begin{asigResponsabilidad}{1011}{El personaje se teletransporta a un lugar cercano}
{[void] OnBlink ()}
...
\begin{asigResponsabilidad}{1012}{El jugador abandona el área de juego}
...
\begin{asigResponsabilidad}{1013}{El jugador abandona el área de juego}
...
\begin{asigResponsabilidad}{1014}{Comunica a la animación que el personaje está rotando}
