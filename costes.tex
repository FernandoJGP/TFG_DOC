...
\begin{itemize}
	\item Dos equipos, un sobremesa y un portátil (para más detalles sobre los equipos, ver sección \ref{sec:arquitectura}) ambos con una vida útil estimada de 3 años ya que el sobremesa, aún siendo más antiguo, ha sido actualizado recientemente.
